...
class AAInfographicsVC: BaseVC {
    ...
    private lazy var tableView = UITableView(frame: .zero, style: .plain).then {
        ...
        $0.registerCell(AAInfographicsCell.self)
    }
...
private extension AAInfographicsVC {
...
extension AAInfographicsVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell: AAInfographicsCell = tableView.dequeueReuseableCell(forIndexPath: indexPath)
        cell.accessoryType = .disclosureIndicator
        if indexPath.row % 2 == 0 {
            cell.backgroundColor = .white
        } else {
            cell.backgroundColor = kRGBColorFromHex(rgbValue: 0xE6E6FA)
        }
...
extension AAInfographicsVC: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        titleLabel.frame = sectionHeaderView.bounds
...
private extension AAInfographicsVC {
    ...
    func kColorWithHexString(_ hexString: String) -> UIColor {
